                    ...
                    onClick = {
                        scope.launch(Dispatchers.Main) {
                            ...
                            withContext(Dispatchers.IO) {
                                ...
                                val user = Usuario(0, emailState, senhaState, false)
                                val call = RetrofitFactory().getService().cadastraUsuario(user)
